...
for i in range(4):
    ...
    if i == 0:
        ...
        fn = "/users/fogliate/LBRun/vdWColumn/Berberan-Santos_et_al_2002/CasoG/Caso{}/processor0/1000000/rho".format(i)
        ...
        fn = "/users/fogliate/LBRun/vdWColumn/Berberan-Santos_et_al_2002/CasoG/Caso{}/processor0/2000000/rho".format(i)
